...
// node_modules/.pnpm/svelte@5.0.0-next.7/node_modules/svelte/src/main/main-client.js
function onMount(fn) {
  if (!is_ssr) {
    user_effect(() => {
...
function createEventDispatcher() {
  ...
  return (type, detail, options) => {
    ...
    const events = $$events == null ? void 0 : $$events[
      /** @type {any} */
      type
    ];
    if (events) {
...
//# sourceMappingURL=chunk-IGKPKIRH.js.map
